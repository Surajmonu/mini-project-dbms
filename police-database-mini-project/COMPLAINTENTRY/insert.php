...
$reg="insert into complaints(cmp_id,cmp_name,case_no,Description,date_reg,police_handle) values('$cmp_id','$cmp_name','$case_no','$Description','$date_reg','$police_handle')";
